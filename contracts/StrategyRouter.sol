...
contract StrategyRouter is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function depositToBatch(address depositToken) external {
        uint _amount = IERC20(depositToken).allowance(msg.sender, address(this));
        if (_amount == 0 ) revert NodepositDetected();
    ...
    */
    ...
    /** @notice Add strategy.
        ...
        @dev Admin function.
        @dev Deposit tokena must be supported by the router.
    */ 
    function addStrategy(
        ...
        address _depositTokenAddress = IStrategy(_strategyAddress).depositToken();
    ...
    */
    ...
    /// @return Balances of the strategies after rebalancing.
    /// @dev Admin function.
